...
# set the flying direction based on player's x position
...
# when eagle enters screen, play the fly animation
func _on_visible_on_screen_notifier_2d_screen_entered():
	animated_sprite_2d.play('fly')
	fly_to_player()


# fly for 3s then detect the player position and fly to that direction again
